...
/**
 * BFS — retourne la longueur minimale du chemin valide (en respectant maxRepConsecutive
 * et disabledCmd), ou null si aucune solution n'existe.
 */
export function computeMinPathLength(
  grid: GridDef,
  keyCount: number,
